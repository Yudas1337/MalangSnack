		...
		<!-- <div class="menu-sidebar">
			<div class="contact-box">
				...
				<ul>
					...
					<li class="nav-item">
                        <a class="nav-link" href="front-food-items.html">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
                ...
                <div class="row">
					<div class="col-xl-12">
						<div class="owl-carousel item-carousel">
                            <?php foreach($main->getCategory() as $category): ?>
							<div class="items">
								<div class="item-box">
					...
					<div class="col-xl-12">
						...
						<div class="row">
                            <?php foreach($main->getProduct() as $product): ?>
								...
								<div class="card item-card">
									<div class="card-body p-0">
										...
										<div class="info">
											...
											<h6 class="mb-0 price"><img src="images/veg.png" alt="">Rp.<?= number_format($product->price) ?></h6>
										</div>
									</div>
								</div>
							</div>
