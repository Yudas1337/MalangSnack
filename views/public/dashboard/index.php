                            ...
                            <div class="card-body p-4">
                                <div class="media ai-icon d-flex">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0 text-black"><span class="counter ms-0"><?= $totalProduct ?></span></h3>
                        ...
                        <div class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media ai-icon d-flex">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0 text-black"><span class="counter ms-0"><?= formHelper::rupiah($revenue) ?></span></h3>
                        ...
                        <div class="widget-stat card">
                            <div class="card-body p-4">
                                <div class="media ai-icon d-flex">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0 text-black"><span class="counter ms-0"><?= $totalOrder ?></span></h3>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header border-0 d-sm-flex d-block">
                                        <div>
                                            <h2 class="main-title text-black mb-1">Produk Terlaris</h2>
                                        </div>
                                    </div>
                                    <div class="card-body pt-3">
                                        <?php foreach ($product->getFavoriteProduct() as $items) : ?>
                                            <div class="media mb-3 pb-3 items-list-2 align-items-center">
                                                <a href="javascript:void(0);"><img class="img-fluid rounded me-3" width="85" src="<?= $uriHelper->assetUrl('images/product/' . $items->thumbnail) ?>" alt="DexignZone"></a>
                                                <div class="ml-3 media-body col-6 px-0">
                                                    <h3 class="mt-0 mb-3 sub-title"><a href="<?= $uriHelper->baseUrl('index.php?page=dashboard&content=product&menu=detail&id=' . $items->id) ?>"><?= $items->name ?></a></h3>
                                                    <span class="font-w500 mb-3"><?= $items->favorit ?> item terjual</span>
                                                </div>
                                                <div class="media-footer align-self-center ms-auto d-block align-items-center d-sm-flex">
                                                    <h3 class="mb-0 font-w600 text-secondary"><?= formHelper::rupiah($items->price) ?></h3>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header border-0 d-sm-flex d-block">
                                        <div>
                                            <h2 class="main-title text-black mb-1">Order Terbaru</h2>
                                        </div>
                                    </div>
                                    <div class="card-body pt-3">
                                        <?php foreach ($order->getNewOrder() as $items) : ?>
                                            <div class="media mb-3 pb-3 items-list-2 align-items-center">
                                                <a href="javascript:void(0);"><img class="img-fluid rounded me-3" width="85" src="<?= $uriHelper->assetUrl('images/profile/' . $items->photo) ?>" alt="DexignZone"></a>
                                                <div class="ml-3 media-body col-6 px-0">
                                                    <h3 class="mt-0 mb-3 sub-title"><a href="<?= $uriHelper->baseUrl('index.php?page=dashboard&content=order&menu=detail&invoice_id=' . $items->invoice_id) ?>"><?= $items->orderName ?></a></h3>
                                                    <span class="font-w500 mb-3"><?= $items->buyTotal ?> item dibeli</span>
                                                </div>
                                                <div class="media-footer align-self-center ms-auto d-block align-items-center d-sm-flex">
                                                    <h3 class="mb-0 font-w600 text-secondary"><?= formHelper::rupiah($items->total_amount) ?></h3>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
