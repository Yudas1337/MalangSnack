            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= $uriHelper->baseUrl("index.php?page=dashboard&content=category&menu=add") ?>" class="btn btn-primary btn-md"><i class="fa fa-plus-circle"></i> Tambah Kategori</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    foreach ($category->getAll() as $list) : ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><img height="100" width="100" src="<?= $uriHelper->baseUrl('assets/images/category/' . $list->icon) ?>" alt="<?= $list->name; ?>"></td>
                                            <td><?= $list->name ?></td>
                                            <td>
